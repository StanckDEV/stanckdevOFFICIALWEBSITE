...
@app.route('/google495aa6fdf106bb3c.html') # Sostituisci con il nome esatto del tuo file
def google_verification():
    return "google-site-verification: google495aa6fdf106bb3c.html" # Scrivi quello che c'è dentro il file
